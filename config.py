...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5010772316:AAEhhF4i3-J3yafTYJEH12Ciyugnyn3ahOk' # Get it from https://t.me/BotFather
    APP_ID = '2135579' # Get it from my.telegram.org/apps
    API_HASH = '00bc86c6b79da918b15fef59e8987254' # Get it from my.telegram.org/apps
